...
function generateCourses(event) {
  ...
  let context =
    "Your are a amrt AI Assistant that knows the best available programming courses online. The list of courses must be provided in HTML format. Example: <li>Course</li>";
  let prompt =
    "Tell me the most popular online programming courses.Maximum 11 listed courses. Sign the list with `This is just a beginning.And it's only going to get better from here.` in <strong> element. </strong> ";
